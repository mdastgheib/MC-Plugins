...
public enum Lang {
    ...
    NO_SHOP("No shop", "&c%s does not have a shop!"),
    SOLD_ITEMS("Sold items", "&aYou sold &b<amount> &aitem(s) for &b$<money>&a!"),
    MULTIPLIER("Multiplier", "&aYou received more money than normal because you have a <multiplier>x multiplier.");
    ...
    public static void init(JavaPlugin plugin) {
        if (configFile == null) configFile = new File(plugin.getDataFolder(), "messages.yml");
