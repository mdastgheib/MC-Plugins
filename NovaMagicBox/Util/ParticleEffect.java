package me.imurder.novamagicbox.Util;
...
public enum ParticleEffect {
    ...
    public void displayToPlayer(Location center, float offsetX, float offsetY, float offsetZ, float speed, int amount, Player player) {
        sendPacket(player, instantiatePacket(name, center, offsetX, offsetY, offsetZ, speed, amount));
    }
